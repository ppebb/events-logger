...
scp -i ~/Home\ Lab/SSH\ Keys/proxmox-vms.pem ./build/events-logger_0.0.999.zip dmz-user@192.168.86.62:/home/dmz-user/. 2> /dev/null
...
cp ./build/events-logger_0.0.999.zip /c/Users/drahk/AppData/Roaming/Factorio/mods/. 2> /dev/null
...
ssh -i ~/Home\ Lab/SSH\ Keys/proxmox-vms.pem dmz-user@192.168.86.62 "sudo mv /home/dmz-user/events-logger_0.0.999.zip /opt/factorio/mods/." 2> /dev/null
printf "${LIGHTBLUE}Setting ownership of Factorio Events Logger Mod to ${GREEN}factorio${NC}\n"
ssh -i ~/Home\ Lab/SSH\ Keys/proxmox-vms.pem dmz-user@192.168.86.62 "sudo chown factorio: /opt/factorio/mods/events-logger_0.0.999.zip" 2> /dev/null
